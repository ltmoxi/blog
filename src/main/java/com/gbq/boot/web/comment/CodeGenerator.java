...
//                //根据自己的位置修改
//                return projectPath + "/boot-gbq-dao/src/main/resources/mapper/" +tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
//            }
//        });
//
//        //控制层
...
//                String expand = projectPath + "/boot-gbq-web/src/main/java/com/gbq/boot/web/" + "controller";
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                String expand = projectPath + "/boot-gbq-service/src/main/java/com/gbq/boot/web/" + "service";
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                String expand = projectPath + "/boot-gbq-service/src/main/java/com/gbq/boot/web/" + "service/impl";
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                String expand = projectPath + "/boot-gbq-dao/src/main/java/com/gbq/boot/web/"+"mapper";
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                String expand = projectPath + "/boot-gbq-dao/src/main/java/com/gbq/boot/web/"+"bean";
